        ...
        <div className="w-full max-w-md p-0 mx-auto">
          <Card>
            <CardHeader className="text-center">
              ...
              <CardDescription>
                Join LearnWise to start your learning journey
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="terms" className="text-sm text-gray-600">
                    I agree to the{" "}
                    <Link to="/terms" className="text-learnwise-600 hover:underline">
                      Terms of Service
                    </Link>{" "}
                    and{" "}
                    <Link to="/privacy" className="text-learnwise-600 hover:underline">
                      Privacy Policy
                    </Link>
                  </Label>
                </div>
              ...
              <div className="mt-6 text-center">
                <p className="text-sm text-gray-600">
                  ...
                  <Link to="/login" className="text-learnwise-600 hover:underline">
                    Sign in
                  </Link>
                </p>
              </div>
