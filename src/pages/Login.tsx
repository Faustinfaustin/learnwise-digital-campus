        ...
        <div className="w-full max-w-md p-0 mx-auto">
          <Card>
            <CardHeader className="text-center">
              <CardTitle className="text-2xl">Login to LearnWise</CardTitle>
              <CardDescription>
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <Link
                      to="/forgot-password"
                      className="text-sm text-learnwise-600 hover:underline"
                    >
                      Forgot password?
                    </Link>
                  </div>
              ...
              <div className="mt-6 text-center">
                <p className="text-sm text-gray-600">
                  ...
                  <Link to="/register" className="text-learnwise-600 hover:underline">
                    Sign up
                  </Link>
                </p>
              </div>
